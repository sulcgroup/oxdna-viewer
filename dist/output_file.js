function makeOutputFiles() {
    ...
    for (let i = 0; i < nucleotides.length; i++) {
        ...
        let z = nuc.pos.z;
        let fx, fy, fz;
        let x_bb = nuc.visual_object.children[0].position.x;
        let y_bb = nuc.visual_object.children[0].position.y;
        let z_bb = nuc.visual_object.children[0].position.z;
        let x_ns = nuc.visual_object.children[1].position.x;
        let y_ns = nuc.visual_object.children[1].position.y;
        let z_ns = nuc.visual_object.children[1].position.z;
        let x_a1;
        let y_a1;
        let z_a1;
        x_a1 = (x_ns - x) / 0.4;
