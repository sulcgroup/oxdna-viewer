...
class TrajectoryReader {
    ...
    parseConf(lines) {
        ...
        if (forceHandler.forces.length > 0) {
            ...
            if (typeof forceHandler.redrawSpheres === "function")
                forceHandler.redrawSpheres();
            // If you have any force-drawn boxes/planes, keep them in sync too
            if (typeof forceHandler.redrawBoxes === "function")
                forceHandler.redrawBoxes();
            if (typeof forceHandler.redrawPlanes === "function")
                forceHandler.redrawPlanes();
        }
