...
instancedBackbone.copy(new THREE.SphereBufferGeometry(.2,50,50) as unknown as THREE.InstancedBufferGeometry); //don't worry about those type conversion, just trying to keep tsc happy
...
instancedBBconnector.copy(new THREE.CylinderBufferGeometry(.1,.02,1, 50) as unknown as THREE.InstancedBufferGeometry);
