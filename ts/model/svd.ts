...
const make_hess_gpu = (net: Network, N: number, hess: number[] ){
    for( let i = 0; i<net.reducedEdges.total; i++){}
...
// Actually we will build/svd/ and calculate the psuedo-inverse all here in this function
// Also i have edited it for the array to be 1D for better storage
// const SVD_gpu = (a: number[], adim: number, withu: boolean, withv: boolean, eps: number) => {
const SVD_gpu = (net: Network, adim: number, withu: boolean, withv: boolean, eps: number) => {
