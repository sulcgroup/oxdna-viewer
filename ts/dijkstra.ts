...
//	}
	...
	getNeigbors(e: BasicElement): BasicElement[] {
		let n = [];
		if(e.neighbor3) {n.push(e.neighbor3);}
		if(e.neighbor5) {n.push(e.neighbor5);}
	 ...
	 */
	shortestPath(start:BasicElement, goals:BasicElement[]){
