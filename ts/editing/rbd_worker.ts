...
let rigidClusterSimulatorW: RigidClusterSimulatorW;
...
class ClusterW {
    ...
    private sim: RigidClusterSimulatorW;
     ...
     */
    constructor(clusterElements: Set<BasicElement>, simulator: RigidClusterSimulatorW) {
